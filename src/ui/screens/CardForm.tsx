...
// gastos y abonos (§5.5). Las deudas en divisa (tarjeta multimoneda) NO se configuran aquí: nacen al
// registrar un gasto en esa moneda o al reconciliar esa moneda desde la pantalla de Tarjetas.
